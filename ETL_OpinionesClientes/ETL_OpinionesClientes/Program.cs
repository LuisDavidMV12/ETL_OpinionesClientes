    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                var encuestasTransformadas = TransformarEncuestas(encuestas);
        ...
        static List<Encuesta> TransformarEncuestas(List<Encuesta> encuestas)
        {
            // Validar puntajes (1-5) y fechas
            return encuestas.Where(e => e.PuntajeSatisfaccion >= 1 && e.PuntajeSatisfaccion <= 5)
            ...
            using (var connection = new SqlConnection(ConnectionString))
            {
                ...
                foreach (var cliente in clientes)
                {
                    var command = new SqlCommand(
                        "INSERT INTO Clientes (IdCliente, Nombre, Email) VALUES (@Id, @Nombre, @Email)",
                        connection);
                ...
                {
                    var command = new SqlCommand(
                        "INSERT INTO Productos (IdProducto, Nombre, Categoria) VALUES (@Id, @Nombre, @Categoria)",
                        connection);
                ...
                foreach (var comentario in comentarios)
                {
                    ...
                    command.Parameters.AddWithValue("@IdCliente", string.IsNullOrEmpty(comentario.IdCliente) ?
                        (object)DBNull.Value : int.Parse(comentario.IdCliente));
                    command.Parameters.AddWithValue("@IdProducto", int.Parse(comentario.IdProducto));
                ...
                foreach (var encuesta in encuestas)
                {
                    ...
                    command.Parameters.AddWithValue("@IdCliente", encuesta.IdCliente);
                    command.Parameters.AddWithValue("@IdProducto", encuesta.IdProducto);
                ...
                foreach (var reseña in reseñas)
                {
                    ...
                    command.Parameters.AddWithValue("@IdCliente", int.Parse(reseña.IdCliente));
                    command.Parameters.AddWithValue("@IdProducto", int.Parse(reseña.IdProducto));
